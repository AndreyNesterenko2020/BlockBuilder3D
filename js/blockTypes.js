game.blockTypes = {
  ...
  tree: [true, true, function(){var this_ = this; var pos = new THREE.Vector3(0, 0, 0).copy(this.block.position); setTimeout(function (){this_.delete(); setTimeout(function() {game.generation.tree(pos.x, pos.y, pos.z)}, 100)}, 100);}, function (){}],
};